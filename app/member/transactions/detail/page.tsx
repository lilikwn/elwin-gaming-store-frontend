...
import DetailRow from '@/components/organism/TransactionDetails/DetailRow'
                    ...
                    <div className="main-content main-content-card overflow-auto">
                        <section className="checkout mx-auto">
                            ...
                            <div className="purchase pt-30">
                                ...
                                <DetailRow label='Price' value={42280000}/>
                                <DetailRow label='Tax (10%)' value={4228000}/>
                                <DetailRow label='Total' value={55000600} additionalClass='color-palette-4'/>
                            </div>
